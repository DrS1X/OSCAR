...
bool hdfOpt::readHDF(string fileName, int *buf) {
    ...
    if (datatype != 24) {
        cout << "The datatype of file-operator is not int32!" << endl;
        return false;
    }
...
void hdfOpt::quickSortForArgo(double *TimeData, long begin, long end, long *CycleIndex, long *DepthData, double *LonData,
    ...
    switch (datatype) {
        ...
        case 20:
        {
            ...
            for (int i = 0; i< m_Rows*m_Cols; i++)
            {
                ...
                val[i]=(int8_databuffer[i]*scale)*1000+0.5 ;*/
            }
