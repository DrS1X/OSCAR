...
# User Options
#-----------------------------------------------------------------------------
set (${HDF4_PACKAGE_NAME}_ENABLE_PARALLEL OFF)
set (${HDF4_PACKAGE_NAME}_BUILD_FORTRAN   OFF)
set (${HDF4_PACKAGE_NAME}_BUILD_JAVA      OFF)
set (${HDF4_PACKAGE_NAME}_BUILD_XDR_LIB   ON)
set (${HDF4_PACKAGE_NAME}_BUILD_TOOLS     ON)
set (${HDF4_PACKAGE_NAME}_BUILD_UTILS     ON)
set (${HDF4_PACKAGE_NAME}_ENABLE_JPEG_LIB_SUPPORT ON)
set (${HDF4_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT ON)
set (${HDF4_PACKAGE_NAME}_ENABLE_SZIP_SUPPORT  ON)
set (${HDF4_PACKAGE_NAME}_ENABLE_SZIP_ENCODING ON)
set (${HDF4_PACKAGE_NAME}_BUILD_SHARED_LIBS    OFF)
set (${HDF4_PACKAGE_NAME}_PACKAGE_EXTLIBS      ON)
set (${HDF4_PACKAGE_NAME}_EXPORT_LIBRARIES xdr-static;hdf-static;mfhdf-static)
...
if (${HDF4_PACKAGE_NAME}_BUILD_JAVA)
  set (${HDF4_PACKAGE_NAME}_JAVA_INCLUDE_DIRS
      ${PACKAGE_PREFIX_DIR}/lib/jarhdf-4.2.13.jar
...
# Version Strings
#-----------------------------------------------------------------------------
set (HDF4_VERSION_STRING 4.2.13)
set (HDF4_VERSION_MAJOR  4.2)
set (HDF4_VERSION_MINOR  13)
...
if (NOT TARGET "hdf4")
  if (${HDF4_PACKAGE_NAME}_ENABLE_JPEG_LIB_SUPPORT AND ${HDF4_PACKAGE_NAME}_PACKAGE_EXTLIBS AND NOT TARGET "jpeg")
    include (${PACKAGE_PREFIX_DIR}/cmake/jpeg-targets.cmake)
  endif ()
  ...
  include (${PACKAGE_PREFIX_DIR}/cmake/hdf4-targets.cmake)
endif ()
    ...
    if (${HAVE_COMP} LESS 0 OR ${HAVE_MFCOMP} LESS 0)
      ...
      if (hdf4_comp2)
        ...
        if (${HAVE_COMP2} LESS 0 OR ${HAVE_MFCOMP2} LESS 0)
          ...
          set (${COMP_LIBRARY} ${${COMP_LIBRARY}} hdf4::${hdf4_comp2}-${libtype} hdf4::${hdf4_comp}-${libtype} hdf4::mf${hdf4_comp2}-${libtype} hdf4::mf${hdf4_comp}-${libtype})
        endif ()
      else ()
        set (${HDF4_PACKAGE_NAME}_${libtype}_${comp}_FOUND 1)
        string(TOUPPER ${HDF4_PACKAGE_NAME}_${comp}_${libtype}_LIBRARY COMP_LIBRARY)
        set (${COMP_LIBRARY} ${${COMP_LIBRARY}} hdf4::${hdf4_comp}-${libtype} hdf4::mf${hdf4_comp}-${libtype})
      endif ()
    endif ()
  endforeach ()
endforeach ()
