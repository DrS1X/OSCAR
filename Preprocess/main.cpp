...
int main(int argc, char *argv[])
{
	...
	case 1: {
		...
		CClsGeneralOperator::getFileList(fileDirectory, subFileDirectory);
		for (int i = 0; i < subFileDirectory.size(); ++i) {
			...
			if (stoi(year) >= 2017 && stoi(year) < 2021) {
				...
				CClsGeneralOperator::getFileList(dir, filePath, fileType);
	...
	case 2: {
		...
		vector<string> list;
		CClsGeneralOperator::getFileList(fileDirectory, list, fileType);
	...
	case 3: {
		...
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\anomaly"), fileSet, string(".hdf"));
	...
	case 4: {
		vector<string> fileSet;
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\resample"), fileSet, string(".hdf"));
	...
	case 5: {
		vector<string> fileSet;
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\spaceTransform"), fileSet, string(".hdf"));
	...
	case 6: {
		vector<string> fileSet;
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\std_05\\pos"), fileSet, string(".tiff"));
	...
	case 7: {
		...
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\cluster_std05_T1\\RepeatFile"), fileSet0, string(".hdf"));
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\cluster_std05_T1\\OtherFile"), fileSet1, string(".hdf"));
	...
	case 8: {
		vector<string> fileSet0, fileSet1;
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\std_05\\pos"), fileSet0, string(".tif"));
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\postprocess"), fileSet1, string(".hdf"));
	...
	case 0: {
		vector<string> fileSet0, fileSet1;
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\tmp\\vec\\ori"), fileSet0, string(".tif"));
		CClsGeneralOperator::getFileList(string("E:\\IMERG\\test\\tmp\\vec\\spa"), fileSet1, string(".hdf"));
